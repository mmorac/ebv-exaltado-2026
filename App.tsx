...
const homeTranslations = {
  es: {
    ...
    success_msg: "Hemos registrado los datos correctamente.",
  ...
  en: {
    ...
    success_msg: "We have registered the data correctly.",
  ...
  pt: {
    ...
    success_msg: "Registramos os dados corretamente.",
            ...
            <div className="flex justify-between items-center h-20 md:h-24">
              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <Button 
                    ...
                    className={`${view === AppView.REGISTER ? 'opacity-0 pointer-events-none' : 'opacity-100'} font-display tracking-wider border-2 border-white/20 px-5 py-2 text-base md:text-xl md:px-8 md:py-3 shadow-lg`}
                >
            ...
            <div className="relative min-h-[500px] md:min-h-[600px] flex items-center justify-center py-12 md:py-20">
               ...
               <div className="relative z-10 max-w-6xl mx-auto text-center px-4 w-full">
                  <div className="flex flex-col sm:flex-row justify-center items-center gap-3 md:gap-4 mb-6 md:mb-8">
                    <div className="inline-block bg-amber-400 text-violet-900 px-6 py-2 md:px-8 md:py-3 rounded-full shadow-[0_4px_0_rgb(180,83,9)] border-4 border-white transform -rotate-2 hover:rotate-0 transition-transform duration-300 animate-in fade-in slide-in-from-top-4 duration-700">
                      <span className="font-display tracking-widest text-lg md:text-2xl font-black whitespace-nowrap">{t.badge_dates}</span>
                    </div>
                    <div className="inline-block bg-sky-400 text-violet-900 px-6 py-2 md:px-8 md:py-3 rounded-full shadow-[0_4px_0_rgb(14,165,233)] border-4 border-white transform rotate-1 hover:rotate-0 transition-transform duration-300 animate-in fade-in slide-in-from-top-4 duration-700 delay-100">
                  ...
                  {/* Standard Hero Title (Magnified Title removed) */}
                  <div className="mb-2 animate-in zoom-in duration-700 relative z-20 mt-8 mb-8">
                  ...
                  <div className="bg-white/95 backdrop-blur-md p-6 md:p-8 rounded-3xl shadow-2xl max-w-4xl mx-auto mb-8 md:mb-12 border-b-[12px] border-sky-500 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 mt-8 relative overflow-visible z-10">
                  ...
                  <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
